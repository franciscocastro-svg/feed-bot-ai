...
Executar um smoke autenticado com apenas um Corte Editorial em Reel 9:16, vídeo com fala e duração suficiente, autopublicação desligada e sem agendamento. Confirmar trecho de pelo menos 20 segundos, nome/foto/@ da conta selecionada, ausência de selo inventado e texto baseado na fala. Depois repetir em Feed 4:5. O bloqueio antigo da fila (`fbe6a2a`), a recaptura da matéria, o replay do Piloto e a correção definitiva do `SIGINT` permanecem atividades separadas.
