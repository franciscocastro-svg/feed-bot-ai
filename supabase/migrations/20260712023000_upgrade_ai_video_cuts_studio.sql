...
-- O pipeline continua funcionando sem xAI; XAI_API_KEY apenas habilita o adapter futuro.
...
-- Rotina segura para apagar originais privados vencidos. A remoção física do
-- Storage é feita pelo backend; esta função apenas devolve os caminhos elegíveis.
