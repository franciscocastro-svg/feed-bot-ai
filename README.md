...
Revisar os três MP4 físicos em `/private/tmp/fluxfeed-editorial-tests`, confirmar enquadramento, nitidez e áreas seguras e, depois, repetir a sincronia com um vídeo que contenha fala real. Somente após o aceite solicitar autorização separada para merge, migration, nova Edge Function, frontend e worker. A recaptura da matéria, o replay do Piloto e a correção do novo bloqueio da VPS permanecem atividades separadas.
