-- Qualidade de Fontes 1B
-- Mantém uma única ocorrência da mesma matéria por cliente durante sete dias,
-- inclusive quando a ocorrência anterior terminou em failed/rejected.
...
BEGIN
  IF TG_OP = 'INSERT' THEN
    -- Serializa apenas as insercoes do mesmo cliente para fechar a janela entre
    -- a consulta de duplicidade e o INSERT em ciclos concorrentes.
