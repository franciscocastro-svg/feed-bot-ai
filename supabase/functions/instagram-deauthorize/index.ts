// Meta calls this webhook when a user removes the app from their Instagram.
...
Deno.serve(async (req) => {
  ...
  try {
    ...
    await admin
      ...
      .update({ active: false, access_token: null, verification_status: 'deauthorized' })
      .eq('ig_user_id', String(data.user_id));
