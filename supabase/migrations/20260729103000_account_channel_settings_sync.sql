-- Per-Instagram channel overrides.
--
-- channel_settings remains the global per-user channel baseline.
-- A missing account_channel_settings row means dynamic inheritance:
-- account_settings -> channel_settings -> user_settings -> system defaults.
-- This migration is intentionally additive and does not rewrite existing data.
