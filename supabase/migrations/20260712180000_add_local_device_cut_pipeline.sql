-- Pipeline híbrido: o dispositivo envia somente áudio para análise e renderiza
-- os cortes finais localmente. O fluxo cloud/VPS permanece disponível.
...
VALUES (
  'video-cut-audio', 'video-cut-audio', false, 104857600,
  ARRAY['audio/mpeg','audio/mp3','audio/mp4','audio/wav','audio/webm','application/octet-stream']
)
...
-- Estende a limpeza existente para liberar créditos reservados quando o
-- usuário abandona uma renderização local por mais de 24 horas.
