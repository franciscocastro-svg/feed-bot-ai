-- =============================================================================
-- Phase 1E-A.2/ii-b — switch the two existing jobs to durable dispatch
--
-- Apply only after the ledger migration and the compatible payments-reconcile
-- deploy. This migration replaces exactly two jobs and creates no extra job.
-- =============================================================================
