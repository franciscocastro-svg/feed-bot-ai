-- Impede que duas fontes simultaneas criem a mesma noticia para a mesma conta.
-- A funcao ainda verifica antes de inserir, mas estes indices fecham a corrida no banco.
