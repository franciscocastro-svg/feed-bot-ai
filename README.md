...
- O terceiro smoke autenticado passou: 7 fontes foram resolvidas e vinculadas, 4 pautas foram criadas e 1 ledger registrou a aplicação, sem publicação automática. O replay da mesma proposta continua pendente.
