-- Notícias em carrossel: preferência herdável por Perfil do Criador.
-- O formato atual permanece como padrão para não alterar clientes existentes.
...
BEGIN
  ...
  -- Reaproveita o salvamento endurecido do Perfil 1A para texto e listas.
